...
const cards = {
  "cards": {
    ...
    "management": {
      ...
      "subtitle": "Administre y supervise todas sus tarjetas en un solo lugar",
      "applyNewCard": "Solicitar Nueva Tarjeta",
      "exportData": "Exportar Datos",
      "searchPlaceholder": "Buscar por número de tarjeta, nombre del titular o ID",
      ...
      "block": "Bloquear Tarjeta",
      "activate": "Activar Tarjeta",
      "openMenu": "Abrir Menú",
      "cardActions": "Acciones de Tarjeta",
      "showingResults": "Mostrando {{count}} tarjetas",
      "noResults": "No se encontraron tarjetas que coincidan con sus criterios.",
