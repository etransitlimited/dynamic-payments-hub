...
const cards = {
  "cards": {
    ...
    "management": {
      ...
      "subtitle": "Manage and monitor all your cards in one place",
      "applyNewCard": "Apply New Card",
      "exportData": "Export Data",
      "searchPlaceholder": "Search by card number, holder name or ID",
      "cardType": "Card Type",
      "status": "Status",
      "totalCards": "Total Cards",
      "activeCards": "Active Cards",
      ...
      "showingResults": "Showing {{count}} cards",
      "noResults": "No cards found matching your criteria.",
      "allCards": "All Cards",
      "active": "Active",
      "pending": "Pending",
