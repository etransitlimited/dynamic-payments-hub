    ...
    >
      ...
      {performanceTier !== 'low' && (
        <>
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-blue-600/10 via-blue-400/5 to-blue-800/10 rounded-3xl -z-5"></div>
        </>
      )}
      ...
      <Card className="bg-gradient-to-br from-blue-500 via-blue-600 to-blue-800 border-blue-900/30 text-blue-50 shadow-xl relative overflow-hidden backdrop-blur-lg">
        {/* Glass reflections */}
