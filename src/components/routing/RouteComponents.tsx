    ...
    <LanguageProvider>
      ...
      <Suspense fallback={<PageLoading />}>
        <Routes>
          ...
          {/* Direct Transaction Access Routes */}
          <Route path="/transactions" element={<Navigate to="/dashboard/transactions" replace />} />
          <Route path="/transactions/*" element={<Navigate to="/dashboard/transactions" replace />} />
          
          {/* Direct Analytics Access Routes */}
          <Route path="/analytics" element={<Navigate to="/dashboard/analytics" replace />} />
          <Route path="/analytics/*" element={<Navigate to="/dashboard/analytics" replace />} />
          
          {/* Direct Card Access Routes */}
          ...
          {/* Wallet Routes with catch-all and specific paths */}
          ...
          {/* Merchant Routes with catch-all and specific paths */}
          ...
          {/* Invitation Routes with catch-all and specific paths */}
