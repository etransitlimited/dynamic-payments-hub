  ...
  return (
    <section className="container mx-auto py-20 px-4 relative z-10">
      ...
      <div className="grid grid-cols-3 gap-4 md:gap-8">
        ...
        >
          <Card className="bg-[#0F2643]/80 backdrop-blur-sm border-blue-900/50 p-4 md:p-6 rounded-xl hover:shadow-[0_0_15px_rgba(0,243,255,0.3)] transition-all duration-300 flex flex-col items-center justify-center h-28 md:h-40">
            <div className="w-20 md:w-32 h-14 md:h-20 flex items-center justify-center bg-white rounded-md">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 324" className="w-16 md:w-24 h-10 md:h-16">
            ...
            <p className="text-cyan-400 font-semibold mt-2 md:mt-4 text-sm md:text-lg">Visa</p>
          </Card>
        </motion.div>
        ...
        >
          <Card className="bg-[#0F2643]/80 backdrop-blur-sm border-blue-900/50 p-4 md:p-6 rounded-xl hover:shadow-[0_0_15px_rgba(0,243,255,0.3)] transition-all duration-300 flex flex-col items-center justify-center h-28 md:h-40">
            <div className="w-20 md:w-32 h-14 md:h-20 flex items-center justify-center bg-white rounded-md">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 131.39 86.9" className="w-16 md:w-24 h-10 md:h-16">
            ...
            <p className="text-cyan-400 font-semibold mt-2 md:mt-4 text-sm md:text-lg">Mastercard</p>
          </Card>
        </motion.div>
        ...
        >
          <Card className="bg-[#0F2643]/80 backdrop-blur-sm border-blue-900/50 p-4 md:p-6 rounded-xl hover:shadow-[0_0_15px_rgba(0,243,255,0.3)] transition-all duration-300 flex flex-col items-center justify-center h-28 md:h-40">
            <div className="w-20 md:w-32 h-14 md:h-20 flex items-center justify-center bg-white rounded-md">
              <CreditCard className="w-10 md:w-16 h-8 md:h-12 text-[#0F2643]" />
            </div>
            <p className="text-cyan-400 font-semibold mt-2 md:mt-4 text-sm md:text-lg">{t("supportedPayments.other")}</p>
          </Card>
        </motion.div>
      </div>
    </section>
