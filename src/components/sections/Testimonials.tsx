          ...
          >
            <Card className="bg-[#0F2643]/80 backdrop-blur-sm border-blue-900/50 p-6 rounded-xl hover:shadow-[0_0_15px_rgba(0,243,255,0.3)] transition-all duration-300 h-full flex flex-col">
              <div className="flex mb-4 items-center">
                {index === 1 ? (
                  // Visa logo
                  <div className="w-16 h-10 flex items-center justify-center bg-white rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 324" className="w-12 h-8">
                  ...
                  // Mastercard logo
                  <div className="w-16 h-10 flex items-center justify-center bg-white rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 131.39 86.9" className="w-12 h-8">
                  ...
                  // Custom payment logo
                  <div className="w-16 h-10 flex items-center justify-center bg-white rounded-md">
                    <CreditCard className="w-8 h-6 text-[#0F2643]" />
                  </div>
                )}
              </div>
              <p className="text-blue-100 mb-6 italic flex-grow">"{t(`testimonials.${index}.quote`)}"</p>
              <div>
