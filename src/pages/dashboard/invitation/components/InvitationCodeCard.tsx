        ...
        <div className="w-full">
          ...
          <div className="flex flex-col space-y-6">
            ...
            <div className="bg-[#061428]/80 rounded-lg p-4 border border-blue-900/30">
              ...
              <div className="bg-[#051020] rounded-md py-3 px-4 font-mono text-xl text-blue-200 border border-blue-900/50 text-center select-all">
                INV-8521-4796
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Button 
                variant="outline" 
                className="h-12 gap-2 border-blue-600/60 text-white hover:bg-blue-900/20"
