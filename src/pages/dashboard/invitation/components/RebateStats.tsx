...
const RebateStats = () => {
  ...
  const stats = [
    {
      title: "invitation.rebate.stats.totalRebate",
      value: "$3,245.50",
      change: "+12.5%",
    ...
    {
      title: "invitation.rebate.stats.invitees",
      value: "124",
      change: "+8.2%",
    ...
    {
      title: "invitation.rebate.stats.conversionRate",
      value: "32.4%",
      change: "+5.7%",
              ...
              <div>
                ...
                <div className="flex items-center mt-1">
                  ...
                  <span className="text-gray-400 text-xs ml-1">
                    <TranslatedText keyName="common.vs_previous" fallback="vs previous" />
                  </span>
                </div>
              </div>
