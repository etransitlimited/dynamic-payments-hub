...
const RebateListCard: React.FC<RebateListCardProps> = ({
  ...
  return (
    <div className="w-full rounded-lg overflow-hidden" style={{ 
      ...
      <Card className="w-full bg-transparent border-blue-800/30 shadow-lg shadow-blue-900/20 hover:shadow-[0_0_15px_rgba(57,106,252,0.15)] transition-all duration-300">
        <div className="absolute inset-0 bg-grid-white/5 [mask-image:linear-gradient(0deg,#000_1px,transparent_1px),linear-gradient(90deg,#000_1px,transparent_1px)] [mask-size:24px_24px]"></div>
        <CardHeader className="relative z-10 bg-blue-950/30 border-b border-blue-800/40 px-6 py-4">
