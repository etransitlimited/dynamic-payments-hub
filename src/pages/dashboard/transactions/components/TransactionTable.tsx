          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-blue-800">
                ...
                <th className="text-left p-3">{isMobile ? '' : t("transactions.user")}</th>
                ...
                <th className="text-left p-3">{isMobile ? '' : t("transactions.date")}</th>
            ...
            <tbody>
              {filteredTransactions.map((transaction) => (
                <tr key={transaction.id} className="border-b border-blue-800/50 hover:bg-blue-900/20">
                  ...
                  <td className={`p-3 ${isMobile ? 'hidden' : ''}`}>{transaction.user}</td>
