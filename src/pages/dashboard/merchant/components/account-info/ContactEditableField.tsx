...
const ContactEditableField: React.FC<ContactEditableFieldProps> = ({
  id,
  label,
  value,
  icon,
        ...
        {icon ? (
          <div className="flex items-center w-full">
            ...
            <Input 
              ...
              className={`rounded-l-none bg-[#061428] border-blue-900/50 text-white ${isEditing ? 'border-blue-400 ring-1 ring-blue-400/50' : ''}`}
            />
          </div>
        ) : (
          <Input 
            ...
            value={value} 
            readOnly={!isEditing || isReadOnly}
            className={`bg-[#061428] border-blue-900/50 text-white ${isEditing ? 'border-blue-400 ring-1 ring-blue-400/50' : ''}`}
          />
        )}
...
export default ContactEditableField;
