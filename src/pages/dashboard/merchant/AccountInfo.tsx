...
const AccountInfo = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-6 space-y-6">
      ...
      <Tabs defaultValue="company" value={activeTab} onValueChange={handleTabChange} className="w-full">
        <TabsList className="w-full grid grid-cols-3 mb-6 bg-blue-950/70 border border-blue-800/30">
          ...
          <TabsTrigger value="contact" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-green-600 data-[state=active]:to-green-500 text-white">
            {t("accountInfo.contactDetails")}
          </TabsTrigger>
          <TabsTrigger value="payment" className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-amber-600 data-[state=active]:to-amber-500 text-white">
