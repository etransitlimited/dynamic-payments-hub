  ...
  return (
    <div className="space-y-6 container px-4 py-6 mx-auto">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold tracking-tight text-white">账户角色</h1>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="bg-[#061428]/70 rounded-lg p-4 border border-blue-900/30">
              <div className="space-y-4">
                <h3 className="text-white text-lg font-semibold">权限说明</h3>
                <ul className="space-y-2 text-blue-200/80 list-disc pl-5">
                  <li>管理员拥有系统的所有操作权限</li>
                  <li>财务角色可以处理系统的财务相关操作</li>
                  <li>客服可以管理用户信息及处理用户问题</li>
                  <li>可以根据业务需求自定义更多角色</li>
                </ul>
              </div>
            </Card>
